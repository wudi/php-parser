...
Reference sources: `~/php-src/Zend/zend_language_scanner.l` (tokens/lexing), `~/php-src/Zend/zend_language_parser.y` (grammar), and `~/php-src/Zend/zend_ast.h` (AST kinds). Do **not** introduce non-PHP syntax or AST kinds; mirror Zend semantics.
