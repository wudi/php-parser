//! PDO Driver Trait Definitions
//!
//! This module defines the core trait abstractions for PDO drivers:
//! - PdoDriver: Driver registration and connection creation
//! - PdoConnection: Connection management and query execution
//! - PdoStatement: Prepared statement execution and result fetching
//!
//! Reference: $PHP_SRC_PATH/ext/pdo/php_pdo_driver.h

use super::types::{Attribute, ColumnMeta, FetchMode, FetchedRow, ParamIdentifier, ParamType, PdoError};
